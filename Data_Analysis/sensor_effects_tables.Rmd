...
tableData %>%
  ...
  gt::gtsave(filename = "Tables/T2_Summary Statistics.html")
...
sjPlot::tab_model(
  ...
  dv.labels = c("Articulation Rate","Vowel Space Area"),
  file = "Tables/T3_articRate and VSA.html"
)
```
...
M1_tableData %>%
  ...
  tab_options(row_group.as_column = TRUE) |>
  gt::gtsave(filename = "Tables/T4_M1.html")
...
M2_tableData %>%
  ...
  gt::cols_hide(c(sig_s, sig_sh)) |>
  tab_options(row_group.as_column = TRUE) |>
  gt::gtsave(filename = "Tables/T5_M2.html")
  

```

# Table 6 - Perceptual Plots
```{r}
workingData_Int <- base::readRDS(file = "Data/workingData/data_Int.RDS")
workingData_Nat <- base::readRDS(file = "Data/workingData/data_Nat.RDS")
...
sjPlot::tab_model(
  ...
  file = "Tables/T6_Perceptual Measures.html"
)

```

# Table S5 - Pairwise Comparisons
```{r}
workingData_articRate <- base::readRDS(file = "Data/workingData/data_articRate.RDS")
workingData_VSA <- base::readRDS(file = "Data/workingData/data_VSA.RDS")
workingData_M1s <- base::readRDS(file = "Data/workingData/data_M1s.RDS")
...
pairwiseContrasts %>%
  ...
  gt::gtsave(filename = "Tables/Table SN_Pairwise Comparisons.html")
