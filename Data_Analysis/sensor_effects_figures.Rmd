...
VSA_summary <- VSA_plotData %>%
  ...
  labs(x = NULL, y = bquote('Vowel Space Area '(kHz ^ 2)),,
...
ggsave(plot = perceptual_plot,
       file = "Figures/F5_Perceptual Rating.png",
       height = 5,
       width = 6.5,
       units = "in",
       scale = 1.2,
