...
rm(artic_rate_plot, emm_artic_rate, lims_group_ar, lims_HC_ar, lims_PD_ar, lims_y_ar, artic_rate)
...
lims_y_VSA <- c(0, (base::max(plot_data$conf.high) + base::max(plot_data$conf.high)*.45))
lims_group_VSA <- base::max(plot_data$conf.high) + base::max(plot_data$conf.high)*.10
lims_HC_VSA <- base::max(plot_data$conf.high) + base::max(plot_data$conf.high)*.05
lims_PD_VSA <- base::max(plot_data$conf.high) + base::max(plot_data$conf.high)*.40
